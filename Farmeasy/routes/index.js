...
router.post('/', function(req, res, next) {
	...
	if(!personInfo.fname || !personInfo.lname || !personInfo.password || !personInfo.confirmpass || !personInfo.email || !personInfo.mobileno){
		res.send();
	} else {
		if (personInfo.password == personInfo.confirmpass) {
...
router.get('/RentalProducts', function (req, res, next) {
	res.render("RentalServiceFrame.ejs");
});

router.get('/InvoiceForm', function (req, res, next) {
